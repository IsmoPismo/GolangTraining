...
This line of code ...
	buckets := make([][]string, 12)
... creates a slice with len and cap equal to 12. I can now access each of the twelve positions in the
		slice by index and assign values to them. If I "append" to this slice, like this ....
		buckets = append(buckets, []string{})
... I am adding another twelve positions to my slice;
		my len increases to 24 and my cap increases to 24.
		This is unnecessary. I can, instead, just direclty begin accessing the first twelve positions
		in my slice ... and that's why I changed the code to this ...
		buckets[i] = []string{}
